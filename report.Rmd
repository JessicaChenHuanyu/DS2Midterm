...
```{r out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("rf_1.png")
```
...
```{r out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("finalmodel.png")
```

```{r out.height='80%', fig.align='center', echo=FALSE}
knitr::include_graphics("testingmodel.png")
```
