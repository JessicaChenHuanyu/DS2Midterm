...
-   Scaling of Predictors: The predictor variables are centered and standardized before applying ridge regression. This is because the penalty term in ridge regression is applied to the coefficients of the predictor variables, and scaling ensures that this penalty is applied uniformly across all predictors.
...
-   Linear Relationship: Similar to ordinary least squares (OLS) regression, ridge regression assumes a linear relationship between the independent variables and the dependent variable.
